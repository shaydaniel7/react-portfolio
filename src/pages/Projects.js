            ...
            <div className="row">
                ...
                <CardDeck>
                    ...
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Card.Title><a href="https://warm-woodland-61603.herokuapp.com/">Burger Logger</a></Card.Title>
                    ...
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Card.Title><a href="https://stormy-garden-29411.herokuapp.com/">Note Taker</a></Card.Title>
                ...
                <CardDeck>
                    ...
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text><Button href="https://github.com/Tbonexas/project2" variant="secondary">repo</Button>
                    ...
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text><Button href="https://github.com/shaydaniel7/user-directory" variant="secondary">repo</Button>
